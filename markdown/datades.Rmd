---
title: "Data Asosiaso Dua Peubah Kategorik"
...
- Hubungan antara status gizi, perkembangan kognitif, dan perkembangan motorik pada anak prasekolah diteliti dalam penelitian pada anak usia prasekolah.
(Forikes, 2021)
...
- Penelitian ini menggunakan metode survei dan mengumpulkan data melalui Google Formulir, menggunakan pertanyaan yang disiapkan sebagai bahan pengumpulan data.
...
- Artikel ini mencakup data tentang skor dan persentase berbagai indikator implementasi teknologi, seperti pembibitan, pengolahan lahan, pemupukan, pengendalian hama, dan pengaturan jarak tanam.
(Saranani & Ulyasniati, 2022)
...
### Deskripsi Data
Artikel ini menggunakan data frekuensi makan dan jenis makanan yang dikonsumsi responden dalam kaitannya dengan terjadinya gastritis.
(Sarwoko, 2023)
...
- Studi ini tidak menemukan korelasi yang signifikan antara asupan lemak dan kadar trigliserida atau antara asupan lemak dan BMI.
(Hidayati et al., 2017)
