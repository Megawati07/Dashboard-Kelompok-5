...
Hubungan Status Gizi dan Perkembangan Anak Umur 0-24 Bulan (Baduta) di Kabupaten Karawang \### Deskripsi Data - Artikel ini menggunakan perkiraan prevalensi nasional, regional, dan global yang diperoleh melalui pemodelan prediktif untuk menilai status perkembangan anak usia dini di negara-negara berpenghasilan rendah dan menengah. Program Lady Health Worker di Pakistan dievaluasi menggunakan uji efektivitas faktorial cluster-randomized untuk menguji efek stimulasi responsif terpadu dan intervensi nutrisi pada perkembangan, pertumbuhan, dan hasil kesehatan anak. - Hubungan antara status gizi dengan perkembangan anak usia 1-3 tahun dieksplorasi dalam penelitian yang dilakukan di daerah Puskesmas Jetis Kota Yogyakarta. - Hubungan antara status gizi, perkembangan kognitif, dan perkembangan motorik pada anak prasekolah diteliti dalam penelitian pada anak usia prasekolah. (Forikes, 2021)
...
Hubungan Asosoasi Antara Inner Child dengan Keharmonisan Keluarga: Pendekatan Menggunakan Uji Chi-Square (Uji Kebebasan) \### Deskripsi Data - Data yang digunakan dalam artikel ini terdiri dari dua variabel, yang diubah dari data kontinu menjadi data diskrit. Variabel diskrit dikategorikan atau dibedakan data, yang dikenal sebagai data nominal atau dikotomis. Misalnya, data dikotomi 1 untuk kategori yang benar dan 0 untuk kategori yang salah. - Penelitian ini menggunakan metode survei dan mengumpulkan data melalui Google Formulir, menggunakan pertanyaan yang disiapkan sebagai bahan pengumpulan data. (Permatasari et al., 2023)
